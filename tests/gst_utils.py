...
def frames_to_video(outfilename, svg_generator, caps="image/svg", container="ts"):
...
def png_to_video(png, mp4, duration=60, container="ts"):
    return frames_to_video(mp4, [(open(png).read(), duration*Gst.SECOND)],
