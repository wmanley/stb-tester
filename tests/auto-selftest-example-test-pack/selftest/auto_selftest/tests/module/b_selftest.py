...
from module.b import *  # isort:skip pylint: disable=wildcard-import, import-error
...
def auto_selftest_TruthyFrameObjectB():
    r"""
    >>> TruthyFrameObjectB(frame=f("frame-object-with-dialog-different-background.png"))
    TruthyFrameObjectB(is_visible=True)
    >>> TruthyFrameObjectB(frame=f("frame-object-with-dialog.png"))
    TruthyFrameObjectB(is_visible=True)
    >>> TruthyFrameObjectB(frame=f("frame-object-with-dialog2.png"))
    TruthyFrameObjectB(is_visible=True)
    >>> TruthyFrameObjectB(frame=f("frame-object-without-dialog-different-background.png"))
    TruthyFrameObjectB(is_visible=True)
    >>> TruthyFrameObjectB(frame=f("frame-object-without-dialog.png"))
    TruthyFrameObjectB(is_visible=True)
    """
    pass
