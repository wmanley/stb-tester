...
from module.a import *  # isort:skip pylint: disable=wildcard-import, import-error
...
def auto_selftest_TruthyFrameObjectA():
    r"""
    >>> TruthyFrameObjectA(frame=f("frame-object-with-dialog-different-background.png"))
    TruthyFrameObjectA(is_visible=True)
    >>> TruthyFrameObjectA(frame=f("frame-object-with-dialog.png"))
    TruthyFrameObjectA(is_visible=True)
    >>> TruthyFrameObjectA(frame=f("frame-object-with-dialog2.png"))
    TruthyFrameObjectA(is_visible=True)
    >>> TruthyFrameObjectA(frame=f("frame-object-without-dialog-different-background.png"))
    TruthyFrameObjectA(is_visible=True)
    >>> TruthyFrameObjectA(frame=f("frame-object-without-dialog.png"))
    TruthyFrameObjectA(is_visible=True)
    """
    pass
