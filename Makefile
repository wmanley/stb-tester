...
extra/service/stbt-ssh-endpoint.py extra/debian/changelog extra/fedora/stb-tester.spec stbt.sh : % : %.in .stbt-prefix VERSION
...
install-core : install-stbt-common install-virtual-stb stbt.sh stbt.1
	$(INSTALL) -m 0755 -d \
	    $(DESTDIR)$(bindir) \
